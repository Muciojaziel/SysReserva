    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acao.equals("adicionaProf")) {
            ...
            for (Professor prof : profs) {
                if ((prof.getSiape() == siape) && (prof.getNome().equals(request.getParameter("nome"))) && (prof.getSenha().equals(request.getParameter("senha")))) {
...
//                else{
//                    ServletContext ctx = getServletContext();
//                    ctx.setAttribute("msg", "Algum Campo esta Incorreto!!! Tente Novamente!");
